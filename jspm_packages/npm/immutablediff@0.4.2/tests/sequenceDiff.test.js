...
describe('Sequence diff', function() {
  ...
  it('check properties', function() {
    JSC.test('returns [] when equal', function(veredict, array) {
  ...
  it('returns correct diff when removing sequenced items in large list', function() {
    ...
    var expected = Immutable.Repeat(Immutable.Map({
      op: 'remove',
      path: '/899'
    }), 100);
    var result = diff(list1, list2);
  ...
  it('returns correct diff when removing multiple sequenced items in large list', function() {
    ...
    var expected = Immutable.List([Immutable.Map({
      ...
      path: "/903",
      value: 954
    })]).concat(Immutable.Repeat(Immutable.Map({
      op: 'remove',
      path: '/904'
    }), 95));
    console.log(result);
  ...
  it('JSCheck', function() {
    JSC.test('returns add when value is inserted in the middle of sequence', function(veredict, array, addIdx, newValue) {
      var list1 = Immutable.fromJS(array);
      var list2 = Immutable.fromJS(array);
    ...
    }, [JSC.array(10, JSC.integer()), JSC.integer(0, 9), JSC.integer()]);
    JSC.test('returns remove', function(veredict, array, removeIdx) {
      var list1 = Immutable.fromJS(array);
      var list2 = Immutable.fromJS(array);
      ...
      return veredict(Immutable.is(result, expected));
    }, [JSC.array(10, JSC.integer()), JSC.integer(0, 9)]);
    JSC.test('returns sequential removes', function(veredict, array, nRemoves) {
      var list1 = Immutable.fromJS(array);
      var list2 = Immutable.fromJS(array);
      ...
      return veredict(Immutable.is(result, expected));
    }, [JSC.array(10, JSC.integer()), JSC.integer(1, 5)]);
    JSC.test('returns replace operations', function(veredict, array, replaceIdx, newValue) {
      var list1 = Immutable.fromJS(array);
      var list2 = Immutable.fromJS(array);
  ...
  it('large sequence diff', function() {
    JSC.test('returns add', function(veredict, array, newValue) {
      var list1 = Immutable.fromJS(array);
      var list2 = Immutable.fromJS(array);
      ...
      return veredict(Immutable.is(result, expected));
    }, [JSC.array(150, JSC.integer()), JSC.integer()]);
    JSC.test('returns replace', function(veredict, array, newValue) {
      var list1 = Immutable.fromJS(array);
      var list2 = Immutable.fromJS(array);
      var idx = 100;
